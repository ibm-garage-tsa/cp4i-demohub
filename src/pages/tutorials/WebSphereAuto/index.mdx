...
<AnchorLinks>
  ...
  <AnchorLink>Configuring Liberty server v20.0.0.12 to WebSphere Automation</AnchorLink>
  <AnchorLink>Configuring Liberty server v20.0.0.9 to WebSphere Automation</AnchorLink>
  <AnchorLink>Configuring traditional WebSphere (tWAS) v9.0.5.6 to WebSphere Automation</AnchorLink>
  <AnchorLink>Configuring traditional WebSphere (tWAS) v9.0.5.7 to WebSphere Automation</AnchorLink>
...
2.Start the environment with the Play button in the top-right corner.
...
## Configuring Liberty server v20.0.0.12 to WebSphere Automation

***

## Configuring Liberty server v20.0.0.9 to WebSphere Automation

***

## Configuring traditional WebSphere (tWAS) v9.0.5.6 to WebSphere Automation

***

## Configuring traditional WebSphere (tWAS) v9.0.5.7 to WebSphere Automation
