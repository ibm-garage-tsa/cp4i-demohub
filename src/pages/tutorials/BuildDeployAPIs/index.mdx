...
**Note: If your using this tutorial in a multi-user ROKS setup, the environment is already prepared for you. Please login to the cluster using LDAP authentication and the credentials provided by your instructor and jump to [Configuring IBM MQ](#configuring-ibm-mq). Also, maske sure that you use a prefix provided by the instructor for queue, topic and server names.**
...
13.	In the terminal window enter oc get svc | grep mq and save mq-demo-ibm-mq IP Adress: 172.21.157.216 (This IP Adress may be different).

![](images/lab1-task1.11.png)

## Configuring IBM MQ


### Task 2 - Configure Message Queue (MQ) to Authorize and Accept Data.
...
### Task 3 – Configuring the integration flow using App Connect Enterprise Toolkit
...
### Task 4 – Deploy Integration BAR file as containers
...
### Task 5 – Configuring API Connect to test the integration
