...
12.On the *Prepare* screen, mark the **REST APIs** checkbox (1). Check **Compile and in-line resources** (2). Click **Build and Save** (3). Now, a popup window displays *Operation completed successfully*. Click **Ok** and **close** the toolkit.
