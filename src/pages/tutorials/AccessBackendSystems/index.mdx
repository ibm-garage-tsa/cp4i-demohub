...
<AnchorLinks>
  <AnchorLink>Task 1 - Configure IBM MQ</AnchorLink>
  <AnchorLink>Task 2 - Working with App Connect Enterprise toolkit</AnchorLink>
  <AnchorLink>Task 3 - Deploying a BAR file</AnchorLink>
  <AnchorLink>Task 4 - Using Operational Dashboard</AnchorLink>
