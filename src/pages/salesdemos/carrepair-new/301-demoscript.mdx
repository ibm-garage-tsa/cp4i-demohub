...
| **Edit API** |   |
| :---         | :--- |
| **Actions**             | Click **Edit API** (1). |
| **Talking Points**      | Let's check our new API in API Manager. Let's put our API Online and test it. |
| **Screenshots**         | &nbsp;  <br/> ![](./images/demoscript-edit-api1.png) <br/> ![](./images/demoscript-download-openapi2.png) |
