...
| **Talking Points**      | We’ll use the same scrips we used to test designer – we’ll just change the variables to point to the CP4I runtime. In the Server, we can get the runtime information. Let's update our variables file and export them again. Now, we just need to run again our script with the same request data. Great, we can check the Salesforce cases page, and voilá here we have our new case created by calling the API in the Integration Runtime.|
...
<details>
<summary>6.1 - Download OpenAPI Document</summary>
...
| **Edit API** |   |
| :---         | :--- |
| **Actions**             | Click **Edit API** (1). Change to **Online** (2).  Click **Test** (3).|
| **Talking Points**      | Let's check our new API in API Manager. Here we put our API Online and test it. |
| **Screenshots**         | &nbsp;  <br/> ![](./images/demoscript-edit-api1.png) <br/> ![](./images/demoscript-edit-api2.png) |
...
| **Edit API** |   |
| :---         | :--- |
| **Actions**             | Copy the **POST URL** (remove */CarRepairClaim*) (1). Copy the **X-IBM-Client-Id** (2).  In your script folder, on *terminal* window, *edit* the **00-variables** file and update the **BASEPATH** and **CLIENTID** (3). Execute **source exportVariables.sh** (4). Execute **./demotestcar.sh** (5). Check the **new case** in *Salesforce* (6).|
...
| **Screenshots**         | &nbsp;  <br/> ![](./images/demoscript-test-apic1.png) <br/> ![](./images/demoscript-test-apic2.png) <br/> ![](./images/demoscript-test-apic3.png) <br/> ![](./images/demoscript-test-apic4.png) <br/> ![](./images/demoscript-testing-runtime5.png) |
