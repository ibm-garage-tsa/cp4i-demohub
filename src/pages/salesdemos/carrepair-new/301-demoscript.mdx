...
| :---         | :--- |
| **Actions**             | Copy the **Endpoint** (1). In your script folder, on *terminal* window, *edit* the **00-variables** file and update the **BASEPATH** (2). Execute **source exportVariables.sh** (3). Execute **./demotestcar.sh** (4). Check the **new case** in *Salesforce* (5).|
