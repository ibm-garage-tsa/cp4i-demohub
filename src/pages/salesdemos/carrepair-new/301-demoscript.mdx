...
| :---         | :--- |
| **Actions**             | Click **Download OpenAPI Document** link (1).|
...
| **Screenshots**         | &nbsp;  <br/> ![](./images/demoscript-download-openapi.png)  |
