...
| :---         | :--- |
| **Actions**             | Open the **Test** tab (1). Open **POST /CarRepairClaim** (2). Open **Try it** (3).  Copy the **URL** (4), **username** (5) and **password** (6). In your script folder, on *terminal* window, *edit* the **variables.txt** file (7) and update the **BasePath** (8), username (9) and password (10). Execute **./exportVariables.sh** (11) |
...
| **Screenshots**         | &nbsp;  <br/> ![](./images/demoscript-variables1.png) |
