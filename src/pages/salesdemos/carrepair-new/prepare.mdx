...
9.Enter **App Connect** as *Connect App Name*. Enter you **admin email** as *Contact Email*. And mark the **Enable OAuth Settings**. Either click on **Enable for Device Flow**. Now select the **Manage your data (api)** as a *Selected OAuth Scopes*. And then click on **Save**.
